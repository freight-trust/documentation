...
> integrated vertically backwards all the way to making its own chips.
> Conversely if motivation is of the essence the market model will
> outperform a network.“

— Networked model of business is an evolution of franchise
...
> entire markets and industries by designing new platforms and offering
> powerful incentives to motivate third parties to participate on them.
> These are very effective because they mobilize investment by a broad
> range of other participants rather than requiring the shaper to put
...
a set of enabling services to support continuous improvement & learning
(enablers)
